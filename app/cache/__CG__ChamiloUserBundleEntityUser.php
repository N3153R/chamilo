...
class User extends \Chamilo\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'userId', 'username', 'usernameCanonical', 'emailCanonical', 'email', 'locked', 'enabled', 'expired', 'credentialsExpired', 'credentialsExpireAt', 'expiresAt', 'lastname', 'firstname', 'password', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'authSource', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'status', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'officialCode', 'phone', 'address', 'imageFile', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'pictureUri', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'creatorId', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'competences', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'diplomas', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'openarea', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'teach', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'productions', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'language', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'registrationDate', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'expirationDate', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'active', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'openid', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'theme', '' . "\0" . 'Chamilo\\UserBundle\\Entity\\User' . "\0" . 'hrDeptId', 'salt', 'lastLogin', 'createdAt', 'updatedAt', 'confirmationToken', 'passwordRequestedAt', 'courses', 'classes', 'dropBoxReceivedFiles', 'dropBoxSentFiles', 'roles', 'profileCompleted', 'groups', 'curriculumItems', 'portals', 'sessionAsGeneralCoach', 'extraFields', 'resourceNodes', 'sessionCourseSubscriptions', 'achievedSkills', 'commentedUserSkills');
        }
    ...
    public function getCompleteNameWithUsername()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompleteNameWithUsername', array());
    ...
    public function getAchievedSkills()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAchievedSkills', array());
    ...
    public function hasSkill(\Chamilo\CoreBundle\Entity\Skill $skill)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasSkill', array($skill));
    ...
    public function isProfileCompleted()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isProfileCompleted', array());
